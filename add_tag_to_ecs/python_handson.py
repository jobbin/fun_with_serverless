...
ACCESS_KEY_ID = "< Your Access Key ID >" # [ Attention ] Don't push your credential to Github !
ACCESS_KEY_SECRET = "< Your Secret Key >" # [ Attention ] Don't push your credential to Github !
